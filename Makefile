...
clean:
	@if [ ! $$(echo -n $(LOG) | wc -m) -ge 1 ]; then \
		printf "\033[0m\033[0;34mRecursive deleting \033[1mbin\033[0m\033[0;34m directory:\033[0m\n"; fi
	$(LOG)rm -rf bin
	@if [ ! $$(echo -n $(LOG) | wc -m) -ge 1 ]; then \
		printf "\033[0m\033[0;34mDeleting \033[1mtests\033[0m\033[0;34m symlink:\033[0m\n"; fi
	$(LOG)rm -f $(OBJECTS_TST) $(TEST_OBJ) $(TEST_EXE)
